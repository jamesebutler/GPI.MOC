...
Namespace RI
    ...
    Public Class ErrorLogger
        ...
        Private Class EventItem
            ...
            Private mMyGlobalUsername As String
            ...
            Public Sub LogSQL()
                ...
                Try
                    ...
                    If Not (connectString Is Nothing) And Not (appName Is Nothing) Then
                        ...
                        sqlCom.Parameters.Add("@UserID", Data.SqlDbType.VarChar, 255).Value = mMyGlobalUsername

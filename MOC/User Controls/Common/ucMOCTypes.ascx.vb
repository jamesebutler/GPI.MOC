...
Partial Class ucMOCTypes
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Page.ClientScript.IsClientScriptIncludeRegistered(Page.GetType, "IncidentTypes") Then Page.ClientScript.RegisterClientScriptInclude(Page.GetType, "IncidentTypes", Page.ResolveClientUrl("~/User Controls/Common/IncidentType.js"))

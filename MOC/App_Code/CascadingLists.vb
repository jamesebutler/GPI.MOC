...
Public Class CascadingLists
    ...
    Public Function GetFacilityList(ByVal knownCategoryValues As String, ByVal category As String, ByVal contextKey As String) As CascadingDropDownNameValue()
        ...
        RI.SharedFunctions.InsertRILoggingRecord("CascadingLists.vb", " GetFacilityList START")
        ...
        RI.SharedFunctions.InsertRILoggingRecord("CascadingLists.vb", " GetFacilityList END")
    ...
    Public Function GetBusArea(ByVal knownCategoryValues As String, ByVal category As String) As CascadingDropDownNameValue()
        ...
        RI.SharedFunctions.InsertRILoggingRecord("CascadingLists.vb", " GetBusArea START")
        ...
        RI.SharedFunctions.InsertRILoggingRecord("CascadingLists.vb", " GetBusArea END")
    ...
    Public Function GetEmployee(ByVal knownCategoryValues As String, ByVal category As String) As CascadingDropDownNameValue()
        ...
        RI.SharedFunctions.InsertRILoggingRecord("CascadingLists.vb", " GetEmployee START")
        ...
        RI.SharedFunctions.InsertRILoggingRecord("CascadingLists.vb", " GetEmployee END")
    ...
    Private Function PopulateEmployee(ByVal SiteID As String) As System.Data.DataSet
        ...
        RI.SharedFunctions.InsertRILoggingRecord("CascadingLists.vb", " PopulateEmployee START")
        ...
        RI.SharedFunctions.InsertRILoggingRecord("CascadingLists.vb", " PopulateEmployee END")
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    <Services.WebMethod(CacheDuration:=0, EnableSession:=False), Script.Services.ScriptMethod()>
    Public Function GetSuperintendentPerson(ByVal knownCategoryValues As String, ByVal category As String) As CascadingDropDownNameValue()
        Dim values As New Generic.List(Of CascadingDropDownNameValue)
        Dim ds As System.Data.DataSet = Nothing
        ...
        Try
            ...
            ds = PopulateSuperintendentPerson(SiteId)


            For Each dr3 As DataRow In ds.Tables(0).Rows
                ' dr3("notifytype")
            Next
            ...
            Do While dr1.Read()
                ...
                Dim val As String = RI.SharedFunctions.DataClean(dr1.Item("Username"))
                Dim desc As String = RI.SharedFunctions.DataClean(dr1.Item("Name"))
        ...
        Catch ex As Exception
            RI.SharedFunctions.HandleError("GetSuperintendentPerson", , ex)
        Finally
            GetSuperintendentPerson = values.ToArray
            If ds IsNot Nothing Then
                ds = Nothing
            End If
    ...
    Private Function PopulateSuperintendentPerson(ByVal SiteID As String) As System.Data.DataSet
        Dim paramCollection As New OracleParameterCollection
        Dim param As New OracleParameter
        Dim ds As System.Data.DataSet = Nothing
        ...
        Try
            ...
            ds = RI.SharedFunctions.GetDSFromPackage(paramCollection, "NEWMOCGPI.GetSuperintendentResponsibleList", "MOCPerson" & SiteID, 2)

        Catch ex As Exception
            ds = Nothing
            RI.SharedFunctions.HandleError("PopulateSuperintendentPerson", , ex)
        Finally
            PopulateSuperintendentPerson = ds
            If ds IsNot Nothing Then
                ds.Dispose()
                ds = Nothing
            End If
    ...
    ''' <returns></returns>
    ''' <remarks></remarks> 
    <Services.WebMethod(CacheDuration:=1800, EnableSession:=True), Script.Services.ScriptMethod()>

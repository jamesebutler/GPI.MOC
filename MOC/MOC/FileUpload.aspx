<%@ Page Language="VB" MasterPageFile="~/RI.master" AutoEventWireup="false" 
    CodeFile="FileUpload.aspx.vb" 
    Inherits="_FileUpload" %>
            ...
            <asp:Table ID="_tblFileAttachments" runat="server" BorderWidth="0" CellSpacing="1"
                ...
                <asp:TableRow>
                    <asp:TableCell Width="150px">
                        <asp:Label ID="_lblFileToUpload" runat="server" Text="<%$RIResources:Shared, FileToUpload%>" /></asp:TableCell><asp:TableCell>
                    ...
                    <asp:TableCell></asp:TableCell>
                        ...
                        <asp:Button ID="_btnCancel" runat="server" Text="<%$RIResources:Shared, Cancel%>"
                                OnClientClick="$(window.location).attr('href', window.location); return false;" />&nbsp;&nbsp;
                        <IP:SpellCheck
                                    ID="SpellCheck1" runat="server" />
                    </asp:TableCell></asp:TableRow><asp:TableRow>
                    <asp:TableCell ColumnSpan="3" HorizontalAlign="Center">
                        <asp:Label ID="_lblFileUploadStatus" runat="server"></asp:Label><br />
                    </asp:TableCell></asp:TableRow></asp:Table></div></asp:Panel><asp:Panel ID="_pnlLinkAttachments" runat="server" GroupingText="">
                ...
                <asp:TableRow>
                    ...
                    <asp:TableCell></asp:TableCell><asp:TableCell HorizontalAlign="center">
                        <asp:Button ID="_btnAttachLink" runat="server" Text="<%$RIResources:Shared, Attach Link%>" OnClick="btnUploadLink_Click"/>&nbsp;<asp:Button
                            ID="_btnCancelLink" runat="server" Text="<%$RIResources:Shared, Cancel%>" OnClientClick="$(window.location).attr('href', window.location); return false;" />&nbsp;&nbsp;
                        <IP:SpellCheck
                                ID="_btnSpellCheck" runat="server"  />
                    </asp:TableCell><asp:TableCell></asp:TableCell></asp:TableRow><asp:TableRow>
                    <asp:TableCell ColumnSpan="3" HorizontalAlign="Center">
                        <asp:Label ID="_lblLinkStatus" runat="server"></asp:Label>
                    </asp:TableCell></asp:TableRow></asp:Table></div></asp:Panel></asp:Panel><br /> 
    <asp:label ID="_lblStatus" runat="server"></asp:label><br />
    <asp:Label ID="_lblFileStatus" runat="server" ></asp:Label><br />
    <br />
    <asp:datagrid id="_dlFileList" runat="server" Width="90%" BackColor="white" AutoGenerateColumns="false" DataKeyField="filename" 
		...
		<asp:TemplateColumn ItemStyle-HorizontalAlign="Left" HeaderText="<%$RIResources:Shared,Filename/Link %>"
			...
			<ItemTemplate>			                          
                <a target="_blank" 
                   href="<%#GetFileLocation(Eval("FileName"), Eval("Location"))%>"><%#Eval("FileName")%>

                </a>
                <br />

                  <%--href="<%# IIf(Eval("savedFileName").ToString() = "", GetFileLocation("",Eval("Location")),Eval("savedFileName"))%>"><%#Eval("FileName")%>--%>

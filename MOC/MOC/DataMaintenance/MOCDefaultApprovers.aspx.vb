...
Partial Class MOC_DefaultApprovers
    ...
    Protected Sub SaveClassNotification()
        ...
        Try
            ...
            'if it is BUM then it is required
            If Me._ddlApproval.SelectedValue = "B" Then
                strRequired = True
            Else
    ...
    Private Sub PopulateNotificationList(ByVal SiteID As String)
        ...
        Try
            ...
            ds3 = RI.SharedFunctions.GetDSFromPackage(paramCollection, "MOCMaint.GetBUANotificationList2", "GetBUANotificationList2", 0)
    ...
    Private Sub MOC_DefaultApprovers_PreInit(sender As Object, e As EventArgs) Handles Me.PreInit

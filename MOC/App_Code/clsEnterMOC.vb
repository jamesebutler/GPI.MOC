...
Public Class clsCurrentMOC
    ...
    Public Property KickOffDate() As String
        Get
            Return mKickOffDate
        End Get
        Set(ByVal value As String)
            mKickOffDate = value.Trim
        End Set
    End Property
    Private mKickOffDate As String
    ...
    Private mSuperintendentType As String = String.Empty
    Public Property SuperintendentType() As String
        Get
            Return mSuperintendentType
        End Get
        Set(ByVal value As String)
            mSuperintendentType = value
        End Set
    End Property

    Private mOutNumber As String = String.Empty
    ...
    Private mSuperintendentName As String = String.Empty
    Public Property SuperintendentName() As String
        Get
            Return mSuperintendentName
        End Get
        Set(ByVal value As String)
            mSuperintendentName = value
        End Set
    End Property

    Private mSuperintendentDate As String = String.Empty
    Public Property SuperintendentDate() As String
        Get
            Return mSuperintendentDate
        End Get
        Set(ByVal value As String)
            mSuperintendentDate = value
        End Set
    End Property
    Private mSuperintendentComments As String = String.Empty
    Public Property SuperintendentComments() As String
        Get
            Return mSuperintendentComments
        End Get
        Set(ByVal value As String)
            mSuperintendentComments = value
        End Set
    End Property


    Public Shared Sub DeleteCurrentMOC(ByVal MOCNumber As Integer, ByVal userName As String)
        RI.SharedFunctions.InsertRILoggingRecord("clsEnterMOC.aspx.vb", CStr(MOCNumber) + " DeleteCurrentMOC ")
        Dim paramCollection As New OracleParameterCollection
        Dim param As New OracleParameter
        Dim ds As System.Data.DataSet = Nothing
        Dim ActiveFlag As String = String.Empty
    ...
    Public Function InsertMOCApproval(ByVal mocNumber As String, ByVal username As String, ByVal approvalType As String, ByVal Required As String, ByVal currentuser As String) As String
        RI.SharedFunctions.InsertRILoggingRecord("clsEnterMOC.aspx.vb", mocNumber + " InsertMOCApproval ")
        Dim paramCollection As New OracleParameterCollection
        Dim param As New OracleParameter
        Dim ds As System.Data.DataSet = Nothing
        ...
        Try
            ...
            If UCase(username) <> "ALL" Then
                ...
                param.OracleDbType = OracleDbType.VarChar
                param.Direction = Data.ParameterDirection.Input
                param.Value = currentuser    'Me.UserName
                paramCollection.Add(param)
    ...
    Public Function InsertMOCApprovalBUM(ByVal mocNumber As String, ByVal username As String, ByVal approvalType As String, ByVal Required As String) As String
        RI.SharedFunctions.InsertRILoggingRecord("clsEnterMOC.aspx.vb", mocNumber + " InsertMOCApprovalBUM ")
        Dim paramCollection As New OracleParameterCollection
        Dim param As New OracleParameter
        Dim ds As System.Data.DataSet = Nothing
        Dim connection As String = String.Empty
        ...
        Try
            ...
            If UCase(username) <> "ALL" Then
                ...
                Dim returnStatus As String = RI.SharedFunctions.CallDROraclePackage(paramCollection, "Reladmin.jebgpi.InsertNewApprovalBUM")
                Return returnStatus
                If CDbl(returnStatus) <> 0 Then
                    Throw New Data.DataException("Error Saving Approval " & mocNumber)
                End If
    ...
    Public Function InsertMOCApprovalSuperintendent(ByVal mocNumber As String, ByVal username As String, ByVal approvalType As String, ByVal Required As String) As String
        RI.SharedFunctions.InsertRILoggingRecord("clsEnterMOC.aspx.vb", mocNumber + " InsertMOCApprovalBUM ")
        Dim paramCollection As New OracleParameterCollection
        Dim param As New OracleParameter
        Dim ds As System.Data.DataSet = Nothing
        ...
        Try
            ...
            If UCase(username) <> "ALL" Then
                ...
                paramCollection.Add(param)
                'TODO: change to production package
                Dim returnStatus As String = RI.SharedFunctions.CallDROraclePackage(paramCollection, "Reladmin.jebgpi.InsertMOCApprovalSuperintendent")


                If CDbl(returnStatus) <> 0 Then
                    Throw New Data.DataException("Error Saving Superintendent Reviewer " & mocNumber)
                End If


                If returnStatus <> "0" And returnStatus <> "777" And returnStatus <> "" Then
                    Throw New Data.DataException("Error Saving Superintendent Reviewer" & Me.MOCNumber)
                Else
                    'get the record just inserted
                    Me.OutNumber = CStr(paramCollection.Item("out_MOCNumber").Value)
                End If
    ...
    Public Function InsertDefaultApprovers(ByVal mocNumber As String, ByVal username As String, ByVal approvalType As String, ByVal CreatedByUsername As String, ByVal Required As String) As String
        RI.SharedFunctions.InsertRILoggingRecord("clsEnterMOC.aspx.vb", mocNumber + " InsertDefaultApprovers ")
        Dim paramCollection As New OracleParameterCollection
        Dim param As New OracleParameter
        Dim ds As System.Data.DataSet = Nothing
        Dim connection As String = String.Empty
        ...
        Try
            ...
            If UCase(username) <> "ALL" Then
                ...
                paramCollection.Add(param)
                'TODO: change to production package
                Dim returnStatus As String = RI.SharedFunctions.CallDROraclePackage(paramCollection, "Reladmin.jebgpi.InsertDefaultApprovers")
                Return returnStatus
                If CDbl(returnStatus) <> 0 Then
                    Throw New Data.DataException("Error Saving Approval " & mocNumber)
                End If
    ...
    Public Shared Function SaveSuperintendentComments(ByVal seqid As Integer, ByVal mocnumber As Integer, ByVal approval_flag As String, ByVal mycomments As String, ByVal username As String) As String
        ...
        Try
            ...
            Dim returnStatus As String = RI.SharedFunctions.CallDROraclePackage(paramCollection, "Reladmin.rimoc.UpdateMOCSuperintendentComment")
    ...
    Public Function SaveMOCApproval(ByVal mocnumber As String, ByVal username As String, ByVal type As String, ByVal Roles As String, ByVal Responded As String) As String
        ...
        RI.SharedFunctions.InsertRILoggingRecord("clsEnterMOC.aspx.vb", mocnumber + " SaveMOCApproval ")
        Dim paramCollection As New OracleParameterCollection
        Dim param As New OracleParameter
        Dim ds As System.Data.DataSet = Nothing
    ...
    Public Function SaveMOCApprovalBySeqId(ByVal mocnumber As String, ByVal username As String, ByVal type As String, ByVal Roles As String, ByVal RowSeqID As String) As String
        RI.SharedFunctions.InsertRILoggingRecord("clsEnterMOC.aspx.vb", mocnumber + " SaveMOCApprovalBySeqId ")
        '(ByVal MOCNumber As Integer, ByVal userName As String)
        Dim paramCollection As New OracleParameterCollection
        Dim param As New OracleParameter
        Dim ds As System.Data.DataSet = Nothing
    ...
    Public Function SaveMOC() As String
        RI.SharedFunctions.InsertRILoggingRecord("clsEnterMOC.aspx.vb", "SaveMOC Enter ")
        Dim paramCollection As New OracleParameterCollection
        Dim param As New OracleParameter
        'Dim ds As System.Data.DataSet  = Nothing
        Dim ActiveFlag As String = String.Empty
        ...
        Try
            ...
            param = New OracleParameter
            'Dim KickOffDate As String = IP.Bids.Localization.DateTime.GetLocalizedDateTime(Me.KickOffDate, "EN-US", "G")
            param.ParameterName = "in_KickOffDate"
            param.OracleDbType = OracleDbType.VarChar
            param.Direction = Data.ParameterDirection.Input
            param.Value = KickOffDate
            paramCollection.Add(param)


            param = New OracleParameter
            param.ParameterName = "in_Funding"
            param.OracleDbType = OracleDbType.VarChar
            param.Direction = Data.ParameterDirection.Input
            param.Value = Me.Funding
            paramCollection.Add(param)
            '
            ...
            param = New OracleParameter
            param.ParameterName = "in_Superintendenttype"
            param.OracleDbType = OracleDbType.NVarChar
            param.Direction = Data.ParameterDirection.Input
            param.Value = Me.SuperintendentType
            paramCollection.Add(param)

            param = New OracleParameter
            param.ParameterName = "in_Superintendentusername"
            param.OracleDbType = OracleDbType.NVarChar
            param.Direction = Data.ParameterDirection.Input
            param.Value = ""
            paramCollection.Add(param)
            ...
            RI.SharedFunctions.InsertRILoggingRecord("clsEnterMOC.aspx.vb", "SaveMOC Before Update ")

            'Dim returnStatus As String = RI.SharedFunctions.CallDROraclePackage(paramCollection, "Reladmin.newmoc.UPDATEMOC")
            'JEB
            Dim returnStatus As String = RI.SharedFunctions.CallDROraclePackage(paramCollection, "Reladmin.newmocgpi.UPDATEMOC")



            RI.SharedFunctions.InsertRILoggingRecord("clsEnterMOC.aspx.vb", "SaveMOC Records Updated " + Me.MOCNumber + " ")
            ...
            RI.SharedFunctions.InsertRILoggingRecord("clsEnterMOC.aspx.vb", "SaveMOC Exit")
    ...
    Public Function UpdateStartMOC() As String
        RI.SharedFunctions.InsertRILoggingRecord("clsEnterMOC.aspx.vb", "UpdateStartMOC Enter ")
        Dim paramCollection As New OracleParameterCollection
        Dim param As New OracleParameter
        'Dim ds As System.Data.DataSet  = Nothing
        Dim ActiveFlag As String = String.Empty
        ...
        Try
            ...
            RI.SharedFunctions.InsertRILoggingRecord("clsEnterMOC.aspx.vb", "UpdateStartMOC Before Update ")

            'Dim returnStatus As String = RI.SharedFunctions.CallDROraclePackage(paramCollection, "Reladmin.newmoc.UPDATEMOC")
            'JEB
            Dim returnStatus As String = RI.SharedFunctions.CallDROraclePackage(paramCollection, "Reladmin.newmocgpi.UpdateStartMOC")



            RI.SharedFunctions.InsertRILoggingRecord("clsEnterMOC.aspx.vb", "UpdateStartMOC Records Updated " + Me.MOCNumber + " ")
    ...
    Private Sub GetMOC()
        ...
        Static start_timeProcedures As DateTime
        Static stop_time As DateTime
        Dim elapsed_time As TimeSpan
        start_time = Now
        start_timeProcedures = Now
        RI.SharedFunctions.InsertRILoggingRecord("clsEnterMOC.aspx.vb", "GetMOC START  ******** " + MOCNumber + " ")

        'Check input paramaters


        'JEB what is this for?
        'Dim ST = New StackTrace(True)
        'Dim SF = New StackFrame()
        'Dim icount As Integer
        'For icount = 0 To ST.FrameCount - 1
        '    SF = ST.GetFrame(icount)
        '    Debug.WriteLine("high up the call stack: " & SF.GetMethod().ToString)
        '    Debug.WriteLine("high up the call stack, Line number: " & SF.GetFileLineNumber().ToString)
        'Next
        ...
        Try
            ...
            'ds = RI.SharedFunctions.GetDSFromPackage(paramCollection, "Reladmin.RIMOC.GETMOC", key, 0)
            ds = RI.SharedFunctions.GetDSFromPackage(paramCollection, "Reladmin.NEWMOCGPI.GETMOC", key, 0)
                    ...
                    If dr IsNot Nothing Then
                        If dr.HasRows Then
                            ...
                            With Me
                                ...
                                .KickOffDate = DataClean(dr.Item("kickoffdate"))
                                ...
                                .Funding = DataClean(dr.Item("Funding"))
                                ...
                                .SuperintendentType = dr.Item("superintendenttype").ToString
                            End With



                            stop_time = Now
                            elapsed_time = stop_time.Subtract(start_timeProcedures)

                            RI.SharedFunctions.InsertRILoggingRecord("clsEnterMOC.aspx.vb", "GetMOC End of HasRows")

                            'RI.SharedFunctions.InsertRILoggingRecord("clsEnterMOC.aspx.vb", "GetMOC End of HasRows", elapsed_time.TotalSeconds.ToString("0.000000"))
        ...
        RI.SharedFunctions.InsertRILoggingRecord("clsEnterMOC.aspx.vb", "GetMOC END  ******** " + MOCNumber + " ")
    ...
    Public Function SaveMOCSystem(ByVal mocnumber As String, ByVal systemseqid As String, ByVal roleseqid As String, ByVal siteid As String, ByVal username As String, ByVal priority As String, ByVal daysafter As String, ByVal taskTitle As String) As String
        RI.SharedFunctions.InsertRILoggingRecord("clsEnterMOC.aspx.vb", "SaveMOCSystem Enter" + mocnumber + " ")
        Dim paramCollection As New OracleParameterCollection
        Dim param As New OracleParameter
        Dim ds As System.Data.DataSet = Nothing
        ...
        Try
            ...
            'Inserted or Updated Table: tblmocsystem
            Dim returnStatus As String = RI.SharedFunctions.CallDROraclePackage(paramCollection, "Reladmin.newmoc.SaveMOCSystem")

            RI.SharedFunctions.InsertRILoggingRecord("clsEnterMOC.aspx.vb", "SaveMOCSystem Recrods retrieved" + mocnumber + " ")
    ...
    Public Function SaveMOCClassQuestionBySeqId(ByVal questionseqid As String, ByVal username As String, ByVal type As String, ByVal answer As String) As String
        RI.SharedFunctions.InsertRILoggingRecord("clsEnterMOC.aspx.vb", " SaveMOCClassQuestionBySeqId ")
        Dim paramCollection As New OracleParameterCollection
        Dim param As New OracleParameter
        Dim ds As System.Data.DataSet = Nothing
    ...
    Public Function SaveMOCCatQuestionBySeqId(ByVal questionseqid As String, ByVal username As String, ByVal type As String, ByVal answer As String) As String
        RI.SharedFunctions.InsertRILoggingRecord("clsEnterMOC.aspx.vb", " SaveMOCCatQuestionBySeqId ")
        Dim paramCollection As New OracleParameterCollection
        Dim param As New OracleParameter
        Dim ds As System.Data.DataSet = Nothing
    ...
    Public Function GetMOCComments() As Data.DataTableReader
        ...
        RI.SharedFunctions.InsertRILoggingRecord("clsEnterMOC.aspx.vb", "GetMOCComments START")
        ...
        Try
            ...
            ds = RI.SharedFunctions.GetDSFromPackage(paramCollection, "Reladmin.RIMOC.GetMOCComments", key, 0)
            If ds IsNot Nothing Then
        ...
        RI.SharedFunctions.InsertRILoggingRecord("clsEnterMOC.aspx.vb", "GetMOCComments END")

    End Function


    Public Function GetCurrentApproverListGPI() As Data.DataSet

        RI.SharedFunctions.InsertRILoggingRecord("clsEnterMOC.aspx.vb", Me.MOCNumber + "GetCurrentApproverListGPI Enter ")
        Dim paramCollection As New OracleParameterCollection
        Dim param As New OracleParameter
        Dim ds As System.Data.DataSet = Nothing
        Dim dr As Data.DataTableReader = Nothing
        ...
        Try
            ...
            param = New OracleParameter
            param.ParameterName = "rsApproverList"
            param.OracleDbType = OracleDbType.Cursor
            param.Direction = Data.ParameterDirection.Output
            paramCollection.Add(param)

            Dim key As String = "GetCurrentApproverListGPI" & MOCNumber

            ds = RI.SharedFunctions.GetDSFromPackage(paramCollection, "Reladmin.RIMOC.GetCurrentApproverListGPI", key, 0)
            RI.SharedFunctions.InsertRILoggingRecord("clsEnterMOC.aspx.vb", Me.MOCNumber + "GetCurrentApproverListGPI Records Retrieved ")
            If ds IsNot Nothing Then
            ...
            End If
            RI.SharedFunctions.InsertRILoggingRecord("clsEnterMOC.aspx.vb", Me.MOCNumber + "GetCurrentApproverListGPI Exit ")
    ...
    Public Function GetDefaultSuperintendentList(ByVal mocNumber As Integer,
                               ByVal in_SiteID As String,
                               ByVal in_notifytypeType As String
                              ) As Boolean
        ...
        Try
            ...
            Dim ds As System.Data.DataSet = Nothing
            Dim dr As Data.DataTableReader = Nothing
            'Get the initial list of approvers based on tblmocnotification table.  
            'This should only show up when an MOC is created.

            param = New OracleParameter
            param.ParameterName = "in_Siteid"
            param.OracleDbType = OracleDbType.VarChar
            param.Value = in_SiteID
            param.Direction = Data.ParameterDirection.Input
            paramCollection.Add(param)

            param = New OracleParameter
            param.ParameterName = "in_notifytypeType"
            param.OracleDbType = OracleDbType.VarChar
            param.Value = in_notifytypeType
            param.Direction = Data.ParameterDirection.Input
            paramCollection.Add(param)
            ...
            ds = RI.SharedFunctions.GetDSFromPackage(paramCollection, "MOCMAINT.GetDefaultSuperintendentBusinessList", "GetDefaultSuperintendentBusinessList" & mocNumber, 0)
            If ds IsNot Nothing Then
                dr = ds.Tables(0).CreateDataReader
                If dr IsNot Nothing Then
                    Do While dr.Read
                        ...
                        If dr.Item("username") IsNot DBNull.Value Then
                            InsertMOCApprovalSuperintendent(mocNumber.ToString, dr.Item("username").ToString, dr.Item("notifytype").ToString, "Y")
    ...
    Public Function GetDefaultBUMList(ByVal mocNumber As Integer,
        ...
        Try
            ...
            ds = RI.SharedFunctions.GetDSFromPackage(paramCollection, "MOCMAINT.GetDefaultApproverListBUM", "GetDefaultApproverListBUM_" & mocNumber, 0)
            If ds IsNot Nothing Then
                dr = ds.Tables(0).CreateDataReader
                If dr IsNot Nothing Then
                    Do While dr.Read
                        ...
                        If dr.Item("username") IsNot DBNull.Value Then
                            InsertMOCApprovalBUM(mocNumber.ToString, dr.Item("username").ToString, "B", "Y")
    ...
    Public Shared Function PrepareL1Email(ByVal mocNumber As Integer,
                             ...
                             ByVal L1Reviewers As String,
                             ByVal NotificationEList As String,
                             ByVal StartDate As String,
                             ByVal Classification As String,
                             ByVal Category As String,
                             ByVal BusinessUnit As String,
                             ByVal SuperintendentApproverName As String,
                             ByVal SuperintendentApproverDate As String,
                             ...
                             ByVal BusinessAreaSuperintendent As String) As Boolean

        RI.SharedFunctions.InsertRILoggingRecord(
            "clsEnterMOC.aspx.vb", " PrepareL1Email ")
        ...
        Try
            ...
            FilePath = HttpContext.Current.Server.MapPath("~\\EmailTemplates\\Level1Approver.html")
            ...
            MailText = MailText.Replace("[ImplementationDate]", StartDate.ToString.Trim())
            ...
            MailText = MailText.Replace("[BusinessUnit]", BusinessUnit.ToString.Trim())

            MailText = MailText.Replace("[SuperintendentApprover]", SuperintendentApproverName.ToString.Trim())
            MailText = MailText.Replace("[SuperintendentApporvalDate]", SuperintendentApproverDate.ToString.Trim())
            MailText = MailText.Replace("[SuperintendentApporvalComments]", SuperintendentComments.ToString.Trim())


            MailText = MailText.Replace("[NotificationL1V]", L1Reviewers.ToString.Trim())
            MailText = MailText.Replace("[NotificationInformed]", NotificationEList.ToString.Trim())
            MailText = MailText.Replace("[Classification]", Classification.ToString.Trim())
        ...
        RI.SharedFunctions.InsertRILoggingRecord(
     "clsEnterMOC.aspx.vb", " PrepareL1Email END")
    ...
    Public Shared Function DeleteMOCApproval(ByVal MOCNumber As String, ByVal userName As String, ByVal approvalType As String, ByVal approvalseqid As String) As String
        ...
        RI.SharedFunctions.InsertRILoggingRecord("clsEnterMOC.aspx.vb", MOCNumber + "DeleteMOCApproval Start")
        Dim paramCollection As New OracleParameterCollection
        Dim param As New OracleParameter
        Dim ds As System.Data.DataSet = Nothing
        Dim ActiveFlag As String = String.Empty
    ...
    Public Function GetFacilityList() As Data.DataSet
    ...
    Public Function GetResponsibleList(ByVal mysite As String) As Data.DataSet


        RI.SharedFunctions.InsertRILoggingRecord("clsEnterMOC.aspx.vb", Me.MOCNumber + "GetResponsibleList Enter ")
        ...
        Try
            ...
            ds = RI.SharedFunctions.GetDSFromPackage(paramCollection, "RIMOC.GetResponsibleList", "MTTResponsible" & mysite, 0)
    ...
    Public Function GetCurrentApproverGPI() As Data.DataSet
        ...
        Try
            ...
            ds = RI.SharedFunctions.GetDSFromPackage(paramCollection, "Reladmin.RIMOC.GetCurrentApproverGPI", key, 0)
            RI.SharedFunctions.InsertRILoggingRecord("clsEnterMOC.aspx.vb", Me.MOCNumber + "GetCurrentApproverGPI Records Retrieved ")
            If ds IsNot Nothing Then
            ...
            End If
            RI.SharedFunctions.InsertRILoggingRecord("clsEnterMOC.aspx.vb", Me.MOCNumber + "")
    ...
    Public Shared Function GetAllSuperintendentList(ByVal SiteID As String) As Data.DataSet
        ...
        Try
            ...
            ds = RI.SharedFunctions.GetDSFromPackage(paramCollection, "SP_MOC_SuperintendentApprovers_List", "GetBUANotificationList", 0)
    ...
    Public Shared Function GetAllSuperintendentAllList() As Data.DataSet
        ...
        Try
            ...
            ds = RI.SharedFunctions.GetDSFromPackage(paramCollection, "SP_MOC_SuperintendentApproversAll_List", "GetBUANotificationList", 0)
        ...
        Finally
            If ds IsNot Nothing Then
                GetAllSuperintendentAllList = ds
                ds.Dispose()
            Else
    ...
    Public Shared Function GetCurrentSuperintendentApproverGPI(in_MOCNumber As Integer, in_SuperintendentType As String) As Data.DataSet

        RI.SharedFunctions.InsertRILoggingRecord("clsEnterMOC.aspx.vb", in_MOCNumber.ToString + "GetCurrentSuperintendentApproverGPI Enter ")
        Dim paramCollection As New OracleParameterCollection
        Dim param As New OracleParameter
        Dim ds As System.Data.DataSet = Nothing
        ...
        Try
            ...
            param.OracleDbType = OracleDbType.VarChar
            param.Direction = Data.ParameterDirection.Input
            param.Value = in_SuperintendentType
            paramCollection.Add(param)
            ...
            Dim key As String = "GetCurrentSuperintendentApproverGPI" & in_MOCNumber

            ds = RI.SharedFunctions.GetDSFromPackage(paramCollection, "Reladmin.RIMOC.GetCurrentSuperintendentApproverGPI", key, 0)
            RI.SharedFunctions.InsertRILoggingRecord("clsEnterMOC.aspx.vb", in_MOCNumber.ToString + "GetCurrentSuperintendentApproverGPI Records Retrieved ")
            If ds IsNot Nothing Then
            ...
            End If
            RI.SharedFunctions.InsertRILoggingRecord("clsEnterMOC.aspx.vb", in_MOCNumber.ToString + "GetCurrentSuperintendentApproverGPI Exit ")
        ...
        Finally
            If ds IsNot Nothing Then
                GetCurrentSuperintendentApproverGPI = ds
                ds.Dispose()
            Else
    ...
    Public Shared Function GetCurrentMOCSuperintendentApproverGPI(in_MOCNumber As Integer, in_SuperintendentType As String) As Data.DataSet
        ...
        Try
            ...
            Dim key As String = "GetCurrentMOCSuperintendentApproverGPI" & in_MOCNumber

            ds = RI.SharedFunctions.GetDSFromPackage(paramCollection, "Reladmin.RIMOC.GetCurrentMOCSuperintendentApproverGPI", key, 0)
            RI.SharedFunctions.InsertRILoggingRecord("clsEnterMOC.aspx.vb", in_MOCNumber.ToString + "GetCurrentMOCSuperintendentApproverGPI Records Retrieved ")
            If ds IsNot Nothing Then
            ...
            End If
            RI.SharedFunctions.InsertRILoggingRecord("clsEnterMOC.aspx.vb", in_MOCNumber.ToString + "GetCurrentMOCSuperintendentApproverGPI Exit ")
        ...
        Finally
            If ds IsNot Nothing Then
                GetCurrentMOCSuperintendentApproverGPI = ds
                ds.Dispose()
            Else
    ...
    Public Shared Function GetMOCReviewersForEmail(in_MOCNumber As Integer) As Data.DataSet


        RI.SharedFunctions.InsertLoggingRecord("clsEnterMOC.aspx.vb", in_MOCNumber.ToString + "GetCurrentSuperintendentApproverGPI Enter ")
        Dim paramCollection As New OracleParameterCollection
        Dim param As New OracleParameter
        Dim ds As System.Data.DataSet = Nothing
        ...
        Try
            ...
            ds = RI.SharedFunctions.GetDSFromPackage(paramCollection, "Reladmin.RIMOC.GetMOCReviewersForEmail", key, 0)
            RI.SharedFunctions.InsertRILoggingRecord("clsEnterMOC.aspx.vb", in_MOCNumber.ToString + "GetMOCReviewersForEmail Records Retrieved ")
            If ds IsNot Nothing Then
            ...
            End If
            RI.SharedFunctions.InsertLoggingRecord("clsEnterMOC.aspx.vb", in_MOCNumber.ToString + "GetMOCReviewersForEmail Exit ")
    ...
    Public Function GetCurrentBUMApproverGPI() As Data.DataSet

        RI.SharedFunctions.InsertRILoggingRecord("clsEnterMOC.aspx.vb", Me.MOCNumber + "GetCurrentBUMApproverGPI Enter ")
        ...
        Try
            ...
            ds = RI.SharedFunctions.GetDSFromPackage(paramCollection, "Reladmin.RIMOC.GetCurrentBUMApproverGPI", key, 0)

            RI.SharedFunctions.InsertRILoggingRecord("clsEnterMOC.aspx.vb", Me.MOCNumber + "GetCurrentBUMApproverGPI Records Retrieved ")
            If ds IsNot Nothing Then
            ...
            End If
            RI.SharedFunctions.InsertRILoggingRecord("clsEnterMOC.aspx.vb", Me.MOCNumber + "GetCurrentBUMApproverGPI Exit ")
    ...
    Public Function GetMOCApprovals() As Data.DataTableReader
        ...
        RI.SharedFunctions.InsertRILoggingRecord(
"clsEnterMOC.aspx.vb", "GetMOCApprovals ")
        ...
        Try
            ...
            ds = RI.SharedFunctions.GetDSFromPackage(paramCollection, "Reladmin.RIMOC.GetMOCApprovals", key, 0)
        ...
        RI.SharedFunctions.InsertRILoggingRecord(
"clsEnterMOC.aspx.vb", "GetMOCApprovals END")
    End Function
    ...
    Public Function GetApprovalsList() As Data.DataTableReader
        ...
        RI.SharedFunctions.InsertRILoggingRecord(
"clsEnterMOC.aspx.vb", "GetApprovalsList START")
        ...
        Try
            ...
            ds = RI.SharedFunctions.GetDSFromPackage(paramCollection, "Reladmin.RIMOC.GetCurrentApproverList", key, 0)
        ...
        RI.SharedFunctions.InsertRILoggingRecord(
"clsEnterMOC.aspx.vb", "GetApprovalsList END")

    End Function

    Public Function GetMOCDefaultQuestions() As Data.DataTableReader
        RI.SharedFunctions.InsertRILoggingRecord("clsEnterMOC.aspx.vb", "GetMOCDefaultQuestions START")
        Dim paramCollection As New OracleParameterCollection
        Dim param As New OracleParameter
        Dim ds As System.Data.DataSet = Nothing
        Dim dr As Data.DataTableReader = Nothing
        ...
        Try
            ...
            ds = RI.SharedFunctions.GetDSFromPackage(paramCollection, "Reladmin.RIMOC.GetMOCQuestions", key, 0)
        ...
        RI.SharedFunctions.InsertRILoggingRecord("clsEnterMOC.aspx.vb", "GetMOCDefaultQuestions END")
    End Function
    ...
    Private Function GetPersonName(ByVal user As String) As String
        ...
        RI.SharedFunctions.InsertRILoggingRecord(
"clsEnterMOC.aspx.vb", "GetPersonName START")
        ...
        Try
            ...
            'ds = RI.SharedFunctions.GetOracleDataSet("SELECT initcap(LastName) lastname, initcap(FirstName) firstname  FROM refEmployee WHERE UPPER(username) = UPPER('" & user & "')")
            ds = RI.SharedFunctions.GetDSFromPackage(paramCollection, "SP_Get_UserName", "SP_Get_UserName", 0)


            stop_time = Now
            elapsed_time = stop_time.Subtract(start_time)
            'RI.SharedFunctions.InsertRILoggingRecord("clsEnterMOC.aspx.vb", "GetPersonName Records Retrieved", elapsed_time.TotalSeconds.ToString("0.000000"))

            RI.SharedFunctions.InsertRILoggingRecord("clsEnterMOC.aspx.vb", "GetPersonName Records Retrieved")
        ...
        RI.SharedFunctions.InsertRILoggingRecord(
"clsEnterMOC.aspx.vb", "GetPersonName END")
    End Function
    ...
    Public Shared Function GetUserEmail(ByVal userList As String) As String
        RI.SharedFunctions.InsertRILoggingRecord("clsEnterMOC.aspx.vb", "GetUserEmail ")
        Dim paramCollection As New OracleParameterCollection
        Dim param As New OracleParameter
        Dim ds As System.Data.DataSet = Nothing
        Dim ActiveFlag As String = String.Empty
    ...
    '    Try
    '        param = New OracleParameter
    '        param.ParameterName = "MyGlobalUsernameList"
    '        param.OracleDbType = OracleDbType.VarChar
    '        param.Direction = Data.ParameterDirection.Input
    ...
    Public Function GetAuthLevel(ByVal user As String, ByVal site As String) As String
        ...
        Try
            ...
            ds = RI.SharedFunctions.GetDSFromPackage(paramCollection, "Reladmin.newmocgpi.GetAuthLevel", key, 8)
    ...
    Public Shared Function GetAndSendImmediateEmail(ByVal taskItemNumber As String, ByVal TaskHeaderNumber As String) As Boolean
        RI.SharedFunctions.InsertRILoggingRecord("clsEnterMOC.aspx.vb", "GetAndSendImmediateEmail ")
        Dim paramCollection As New OracleParameterCollection
        Dim param As New OracleParameter
        Dim ds As System.Data.DataSet = Nothing
        ...
        Dim strDB As String
        'Dim ipLoc As New IP.Bids.Localization.WebLocalization(rowItem.RESPONSIBLEMyGlobalDefaultLanguage, "RI")
            ...
            If ds IsNot Nothing Then
                If ds.Tables.Count = 1 Then
                    ...
                    Do While dr.Read
                        ...
                        strEmailAddress = DataClean(dr.Item("responsibleMyGlobalEmail"))
    ...
    Public Function SaveMOCUSD(ByVal mocnumber As String, ByVal desc As String) As String
        RI.SharedFunctions.InsertRILoggingRecord("clsEnterMOC.aspx.vb", " SaveMOCUSD ")
        Dim paramCollection As New OracleParameterCollection
        Dim param As New OracleParameter
        Dim ds As System.Data.DataSet = Nothing
    ...
    Public Function SaveMOCTemplateTasks(ByVal mocnumber As String, ByVal temptaskseqid As String, ByVal RespUsername As String, ByVal RespRole As String, ByVal Facility As String, ByVal Description As String, ByVal DaysAfter As String, ByVal DueDate As String, ByVal username As String) As String
        ...
        Try
            ...
            If IsNothing(DueDate) Then
                strdueDate = ""
            Else
                strdueDate = DueDate 'IP.Bids.Localization.DateTime.GetLocalizedDateTime(DueDate, "EN-US", "d")
    ...
    Public Function CopyMOC() As String
        RI.SharedFunctions.InsertRILoggingRecord("clsEnterMOC.aspx.vb", Me.MOCNumber + " CopyMOC ")
        Dim paramCollection As New OracleParameterCollection
        Dim param As New OracleParameter
...
Public Class reviewersUpdate


    'JEB
    Public Function InsertMOCApprovalJEB(ByVal mocNumber As String, ByVal username As String, ByVal approvalType As String, ByVal Required As String, ByVal currentuser As String) As String
        RI.SharedFunctions.InsertRILoggingRecord("clsEnterMOC.aspx.vb", mocNumber + " InsertMOCApproval ")
        Dim paramCollection As New OracleParameterCollection
        Dim param As New OracleParameter
        Dim ds As System.Data.DataSet = Nothing
    ...
    Public Shared Function DeleteMOCApprovalBySeqid(ByVal MOCNumber As String, ByVal approvalseqid As String) As String


        RI.SharedFunctions.InsertRILoggingRecord("clsEnterMOC.aspx.vb", MOCNumber + "DeleteMOCApprovalBySeqid Start")
        Dim paramCollection As New OracleParameterCollection
        Dim param As New OracleParameter
        Dim ds As System.Data.DataSet = Nothing
        Dim ActiveFlag As String = String.Empty
        ...
        Try
            ...
            Dim returnStatus As String = RI.SharedFunctions.CallDROraclePackage(paramCollection, "Reladmin.MOCMAINT.DeleteMOCApprovalBySeqid")
            Return returnStatus
    ...
    '    Public Function GetApprovalsListJEB() As Data.DataTableReader


    '        RI.SharedFunctions.InsertRILoggingRecord(
    '"clsEnterMOC.aspx.vb", "GetApprovalsListJEB ")

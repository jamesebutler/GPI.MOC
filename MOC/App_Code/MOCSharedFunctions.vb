...
Namespace RI
    ''' <summary>
    ''' This class contains a list of MOC shared functions that can be used by any page
    ''' </summary>
    ''' <remarks></remarks>
    Public Class MOCSharedFunctions
        ...
        Shared Function IsAdminUser(ByVal name As String) As Boolean
            ...
            adminUsers.Add("NA\James.Butler")
            Return adminUsers.Contains(name)
        End Function
        ''' <summary>
        ''' This shared function executes an Oracle SQL statement and returns the Rowid for the modified or inserted row
        ''' </summary>
        ...
        ''' <returns>String - Unique Rowid of the modified or inserted row</returns>
        ''' <remarks></remarks>
        Shared Function ExecuteSQL(ByVal sql As String, Optional ByVal connection As String = "", Optional ByVal provider As String = "") As OracleString
            ...
            Try
                ...
                affectedRows = cmdSQL.ExecuteNonQuery 'ExecuteOracleNonQuery(Rowid)
        ...
        ''' <remarks></remarks>
        Public Shared Sub StoreDataIntoSQLServerCache(ByVal criteria As Object, ByVal resultSet As String)
        ...
        ''' <remarks></remarks>
        Public Shared Sub StoreDataIntoSQLServerCache(ByVal criteria As Object, ByVal resultSet As Object)
        ...
        End Sub
        Shared Sub SendEmail(ByVal toaddress As String, ByVal fromAddress As String, ByVal subject As String, ByVal body As String, Optional ByVal displayName As String = "Graphic Packaging", Optional ByVal carbonCopy As String = "", Optional ByVal blindCarbonCopy As String = "", Optional ByVal IsBodyHtml As Boolean = True, Optional ByVal Attachment As Mail.AttachmentCollection = Nothing)
            ...
            Try
                ...
                If OkToSend = True Then
                    RI.SharedFunctions.InsertAuditRecord("Send Email", "The following email has been sent -  " & Mid(body, 1, 3000) & "<br> Recipients:" & inputAddress.ToString)
                    ...
                    Do While emailTryCount < 5 And emailSuccess = False
                        ...
                        Catch ex As SmtpException
                            ...
                            RI.SharedFunctions.InsertAuditRecord("Send Email Error", "The following email was not sent - Retry(" & emailTryCount & ") -  " & Mid(body, 1, 3000) & "<br> Recipients:" & inputAddress.ToString)
                        Finally
                            client = Nothing
                        End Try

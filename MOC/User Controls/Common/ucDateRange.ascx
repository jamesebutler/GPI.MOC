...
<%@ Register Src="~/User Controls/Common/ucStartEndCalendar.ascx" 
TagName="StartEndCalendar" TagPrefix="IP"%>


<asp:Table ID="tblMain" runat="server" CellPadding="0" BorderStyle="Solid" BorderColor="Red" 
CellSpacing="0" Width="100%" BorderWidth="0">

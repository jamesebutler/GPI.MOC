...
<%--   <tr class="">
        <th colspan="1" align="left">
            <asp:Label ID="_lblMOCStatus1" runat="server" Text="MOC Status"
    ...
    <tr class="Border">
        <td><asp:Label ID="_lblMOCStatus" runat="server" Text="MOC Status"
...
<div id="_divStatusDefinition" class="modalPopup" style="display: none">
    ...
    <asp:Localize ID="_StatusDef" runat="server" Text="<%$ RIResources:Shared,StatusDefinition %>"></asp:Localize>
       <%-- <asp:Localize ID="_StatusDef" runat="server" Text="I'm here."></asp:Localize>--%>

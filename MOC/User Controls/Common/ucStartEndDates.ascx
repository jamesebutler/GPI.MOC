<%@ Control EnableTheming="false" Language="VB" AutoEventWireup="false"
    CodeFile="ucStartEndDates.ascx.vb" Inherits="RI_User_Controls_Common_ucStartEndDates" %>
<script>
...
<asp:Table ID="tblStartEndDates" runat="server" CellPadding="0" BorderStyle="Dashed" BorderColor="Green" 
CellSpacing="0" Width="40%" BorderWidth="3">
    <asp:TableRow  >

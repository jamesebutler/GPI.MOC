...
Partial Class ucSwapList
    ...
    Public ReadOnly Property HiddenSelectedValue() As String
        Get
            Return Me._hdSelectedFields.Value
        End Get
    End Property
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Page.ClientScript.IsClientScriptIncludeRegistered(Page.GetType, "SwapListBox" & Me.ID) Then Page.ClientScript.RegisterClientScriptInclude(Page.GetType, "SwapListBox" & Me.ID, Page.ResolveClientUrl("~/User Controls/Common/SwapListBox.js"))
        Dim hiddenFields As String = "','" & Me._hdfAllFields.ClientID.ToString & "','" & Me._hdSelectedFields.ClientID.ToString
        If Not Page.ClientScript.IsOnSubmitStatementRegistered(Page.GetType, "SwapListPost" & Me.ID) Then Page.ClientScript.RegisterOnSubmitStatement(Page.GetType, "SwapListPost" & Me.ID, "selectAll('" & Me._lbAllFields.ClientID.ToString & "',  '" & Me._lbSelectedFields.ClientID.ToString & hiddenFields & "');")

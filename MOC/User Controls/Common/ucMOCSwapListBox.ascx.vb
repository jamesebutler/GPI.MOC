...
Partial Class ucMOCSwapList
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        RI.SharedFunctions.InsertRILoggingRecord("ucMOCSwapListBox.aspx.vb", "START - Page_Load ")
        ...
        Else
            ...
            If Not Page.ClientScript.IsClientScriptIncludeRegistered(Page.GetType, "MOCSwapListBox") Then Page.ClientScript.RegisterClientScriptInclude(Page.GetType, "MOCSwapListBox", Page.ResolveClientUrl("~/User Controls/Common/MOCSwapListBox.js"))
        ...
        Me._rbL1Approvers.Attributes.Add("onClick", "this.form." & Me._rbL1Approvers.ClientID & ".checked=true;this.form." & Me._lbApproversL1.ClientID & ".className='Border';this.form." & Me._lbInformed.ClientID & ".className='';this.form.")
        ...
        RI.SharedFunctions.InsertRILoggingRecord("ucMOCSwapListBox.aspx.vb", "END - Page_Load ")

    End Sub

    Public Overrides Sub DataBind()

        RI.SharedFunctions.InsertRILoggingRecord("ucMOCSwapListBox.aspx.vb", "START - DataBind ")
        ...
        RI.SharedFunctions.InsertRILoggingRecord("ucMOCSwapListBox.aspx.vb", "END - DataBind ")
    ...
    Function BuildMoveDualListJS(ByVal list1 As ListBox, ByVal list2 As ListBox, ByVal list3 As ListBox, ByVal list4 As ListBox, ByVal list5 As ListBox, ByVal moveAll As Boolean, ByVal sortList As Boolean, Optional ByVal reverseMove As Boolean = False) As String
        'Function BuildMoveDualListJS(ByVal list1 As ListBox, ByVal list4 As ListBox, ByVal list5 As ListBox, ByVal moveAll As Boolean, ByVal sortList As Boolean, Optional ByVal reverseMove As Boolean = False) As String

        RI.SharedFunctions.InsertRILoggingRecord("ucMOCSwapListBox.aspx.vb", "START - BuildMoveDualListJS ")
        ...
        RI.SharedFunctions.InsertRILoggingRecord("ucMOCSwapListBox.aspx.vb", "END - BuildMoveDualListJS ")
    End Function

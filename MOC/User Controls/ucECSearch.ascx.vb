...
Partial Class ucECSearch
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.ClientScript.IsClientScriptIncludeRegistered(Page.GetType, "ucECSearch") Then
            Page.ClientScript.RegisterClientScriptInclude(Page.GetType, "ucECSearch", Page.ResolveClientUrl("~/User Controls/ucECSearch.js"))
        End If
    ...
    Public Sub SetEquipmentDescription(ByVal equipmentId As String)
        RI.SharedFunctions.InsertRILoggingRecord("ucECSearch.ascx.vb", "SetEquipmentDescription START ")
        ...
        Loop
        RI.SharedFunctions.InsertRILoggingRecord("ucECSearch.ascx.vb", "SetEquipmentDescription EXIT ")
    End Sub

...
Partial Class MOC_MyMOCsNew
    Inherits RIBasePage

    Dim currentMOC As clsCurrentMOCDetail
    Dim currentMOCDetail As clsCurrentMOC

    Private Sub MOC_MyMOCsNew_PreInit(sender As Object, e As EventArgs) Handles Me.PreInit
    ...
    Function GetUserid() As String
        ...
        'Return userProfile.Username.ToString
    ...
    Protected Sub GetMOCs()
        ...
        clsSearch.Approver = GPI.XML.XMLUtility.ReadXmlNode(Session("UserProfile").ToString, "Username") 'GetUserid()

        If CStr(Session("ImpersonateUser")) = "nothing" Then
            'do nothing
        Else
            clsSearch.Approver = CStr(Session("ImpersonateUser"))
        End If
    ...
    Protected Sub _btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles _btnSave.Click
        ...
        Dim userprofileEmail As String = GPI.XML.XMLUtility.ReadXmlNode(Session("UserProfile").ToString, "Email")
            ...
            If strApproval <> "" Then
                ...
                ElseIf returnStatus = "777" Then
                    ...
                    If strLevel = "L1" And currentMOC.NotificationL2List <> "" Then
                        ...
                        EmailApproved(strMOCNumber, strEmailList, userprofileEmail, Master.RIRESOURCES.GetResourceValue("All Level 1 Approvers have approved this MOC and awaiting Level 2 approval"))
                    ElseIf strLevel = "L2" And currentMOC.NotificationL3List <> "" Then
                        strEmailList = currentMOC.NotificationL3List
                        EmailApproved(strMOCNumber, strEmailList, userprofileEmail, Master.RIRESOURCES.GetResourceValue("All Level 1 & Level 2 Approvers have approved this MOC and awaiting Level 3 approval"))
                    End If
                End If
    ...
    Private Sub EmailNotApproved(ByVal MOCNumber As String, Optional ByVal toList As String = "", Optional ByVal ccList As String = "", Optional ByVal Comments As String = "")
        ...
        Dim userprofileEmail As String = GPI.XML.XMLUtility.ReadXmlNode(Session("UserProfile").ToString, "Email")
        Dim userprofileFullName As String = GPI.XML.XMLUtility.ReadXmlNode(Session("UserProfile").ToString, "FullName")
        ...
        Body.Append(Master.RIRESOURCES.GetResourceValue("This MOC was not approved by") & " " & userprofileFullName & ".<br>")
        ...
        RI.SharedFunctions.SendEmail(toList, userprofileEmail, subjectForNotificationList, msgForNotificationList, GPI.XML.XMLUtility.ReadXmlNode(Session("UserProfile").ToString, "FullName"), ccList)

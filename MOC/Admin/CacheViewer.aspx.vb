...
Partial Class Admin_CacheViewer
    Inherits RIBasePage
    ...
    Private Sub GetAndDisplayCacheItems()
        ...
        Try
            ...
            For Each objItem In ctx.Cache
                strName = objItem.Key
                If strName = "ResourceCache_EN-US_RI" Or strName = "ResourceCache_EN-US_RI_MissingKeys" Then
                    'do nothing
                Else
    ...
    Private Sub Admin_CacheViewer_PreInit(sender As Object, e As EventArgs) Handles Me.PreInit

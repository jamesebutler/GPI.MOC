...
Partial Class ucStartEndCalendar
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.ClientScript.IsClientScriptIncludeRegistered(Page.GetType, "StartEndCalendar") Then Page.ClientScript.RegisterClientScriptInclude(Page.GetType, "StartEndCalendar", Page.ResolveClientUrl("~/User Controls/Common/StartEndCalendar.js"))
        SetupPopupCalendar(True)

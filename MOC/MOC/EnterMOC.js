    ...
    try {
		...
		if (arg.length>0){
	    	...
	    	//alert(location.hostname);	
    		    win = viewPopUp('http://gpiri.graphicpkg.com:130/Popups/TaskList.aspx?HeaderNumber=' + arg + '&RefSite=MOC&InFrame=false&AllowEdit=true&ShowHeaderInfo=false', 'YOU HAVE ATTEMPTED TO LEAVE THIS PAGE. IF YOU HAVE MADE ANY CHANGES TO THE FIELDS WITHOUT CLICKING THE SAVE BUTTON, YOUR CHANGES', 'MTT');
            }

<%@ Page Language="VB" MasterPageFile="~/RI.master" AutoEventWireup="false" CodeFile="MyMOCs.aspx.vb"
	Inherits="MOC_MyMOCs" EnableTheming="true"
	EnableEventValidation="false" Title="Graphic Packaging: MOC" Trace="false"
...
<br />
 ...
 <br />
        ...
        <span id="_spPending" runat="server" backcolor="#CCCCCC" style="border: thin solid #000000;" >
			        <asp:Label ID="_lblRecCount" runat="server" Text="0" BackColor="#ffffff" Font-Size="12pt" Width="100%" Font-Italic="True" BorderColor="Black"></asp:Label>
	        <br />
...
<br /> <br />
        ...
        <span id="_spPendingOwner" runat="server">
            <asp:Label ID="_lbPendingOwner" runat="server" Text="0" BackColor="#ffffff" Font-Size="12pt" Width="100%" Font-Italic="True" ></asp:Label>
	        <br />


			<asp:GridView ID="_gvPendingOwner" runat="server"
                CssClass="Border"
                BorderColor="Black"
				BorderWidth="2"
                AutoGenerateColumns="False"
                DataKeyNames="MOCNUMBER"
...
<asp:Panel ID="_pnlStartofNew" runat="server" Width="100%" HorizontalAlign="Left" Visible="false"> 

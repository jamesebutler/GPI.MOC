...
Partial Class ucMOCStatus
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Me._hypStatusDefinition.NavigateUrl = "javascript:var x=dhtmlmodal.open('StatusDefinition', 'div', '_divStatusDefinition', '" & ipLoc.GetResourceValue("Definition", False, "Shared") & "', 'width=800px,height=550px,center=1,resize=0,scrolling=1');"
    End Sub
    ...
    Private Sub PopulateStatus()
        ...
        With li
            ...
            .Add("Superintendent Requested", "Superintendent Requested")
